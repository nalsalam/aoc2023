...
Today's puzzle is all about reorganizing the puzzle input in a way that makes
it easy to calculate the maximum number of red's, green's, and blue's in each game.

This gave me a chance to use some tidyverse functions like `separate_delimiter_wider` and `separate_delimiter_longer` that I've learned about recently.
